...
const AMBER = 'oklch(0.82 0.15 72 / 0.5)'
const TERRA = 'oklch(0.68 0.13 46 / 0.45)'
const SAGE = 'oklch(0.72 0.09 165 / 0.42)'
...
const CELLS: {
  ...
  { left: 52, top: 156, color: AMBER, delay: '0s', dur: '4.2s' },
  { left: 208, top: 312, color: TERRA, delay: '1.6s', dur: '5.1s' },
  { left: 104, top: 520, color: SAGE, delay: '3.1s', dur: '4.7s' },
  { left: 312, top: 104, color: AMBER, delay: '2.2s', dur: '6.0s' },
  { left: 416, top: 416, color: TERRA, delay: '0.8s', dur: '5.4s' },
  { left: 260, top: 624, color: AMBER, delay: '4.0s', dur: '4.4s' },
  { left: 520, top: 208, color: SAGE, delay: '2.7s', dur: '5.8s' },
  { left: 624, top: 468, color: AMBER, delay: '1.1s', dur: '4.9s' },
  { left: 468, top: 676, color: TERRA, delay: '3.6s', dur: '5.2s' },
  { left: 728, top: 156, color: AMBER, delay: '0.4s', dur: '6.2s' },
