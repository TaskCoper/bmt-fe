...
export function LandingHero() {
  ...
  return (
    <section id={LANDING_SECTIONS.home} className='relative overflow-hidden border-b'>
      ...
      <div className='relative mx-auto flex w-full max-w-5xl flex-col items-center px-4 py-24 text-center lg:py-32'>
        ...
        <p className='text-muted-foreground mt-6 max-w-2xl text-lg text-pretty'>{t('subtitle')}</p>
