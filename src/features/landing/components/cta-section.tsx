    ...
    <section className='py-20 lg:py-28'>
      <div className='mx-auto w-full max-w-7xl px-4 lg:px-8'>
        <div className='bg-primary text-primary-foreground relative overflow-hidden rounded-2xl px-6 py-16 text-center sm:px-12'>
          <h2 className='text-heading mx-auto max-w-2xl text-balance'>{t('title')}</h2>
          <p className='text-primary-foreground/80 mx-auto mt-4 max-w-xl text-pretty'>{t('subtitle')}</p>
