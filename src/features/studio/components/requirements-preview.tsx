    ...
    <div className='glass-panel flex flex-col overflow-hidden lg:sticky lg:top-24'>
      ...
      <div className='relative flex flex-1 items-center justify-center px-6 py-8'>
        <div
          ...
          style={{
            background: 'radial-gradient(120% 80% at 50% 120%, oklch(0.77 0.155 65 / 0.2), transparent 62%)'
          }}
        />
        <svg
          viewBox='0 0 240 200'
          ...
          aria-hidden
        >
          <line x1='20' y1='182' x2='220' y2='182' stroke='var(--primary)' strokeWidth='1.5' opacity='0.55' />
          <rect
            x='60'
            y='96'
            width='120'
          ...
          <rect x='74' y='106' width='16' height='12' fill='var(--primary)' opacity='0.55' />
          <rect x='100' y='106' width='16' height='12' fill='var(--primary)' opacity='0.55' />
          <rect x='74' y='132' width='16' height='12' fill='var(--primary)' opacity='0.55' />
          <rect x='100' y='132' width='16' height='12' fill='var(--primary)' opacity='0.55' />
          <rect x='140' y='154' width='20' height='28' fill='currentColor' opacity='0.75' className='text-foreground' />
        </svg>
      </div>
      ...
      <div className='border-glass-border flex flex-wrap gap-2 border-t px-6 py-5'>
        ...
        {showTum ? <span className='glass-inset rounded-xl px-3 py-1.5 text-xs font-medium'>{t('tum')}</span> : null}
      </div>
    </div>
  )
}
