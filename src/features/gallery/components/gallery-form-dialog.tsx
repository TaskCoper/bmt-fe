...
import { GALLERY_BUILDING, GALLERY_KIND, GALLERY_STYLE } from '../constants/gallery.constants'
import type { GalleryItem } from '../types/gallery.types'

/** Admin create/edit dialog for a design-library item (Q&A §6 / §7.2.2). */
export function GalleryFormDialog({ trigger, item }: { trigger: ReactNode; item?: GalleryItem }) {
        ...
        >
          ...
          <div className='grid gap-4 sm:grid-cols-3'>
            ...
            <div className='space-y-2'>
              ...
              <Select defaultValue={item?.building ?? GALLERY_BUILDING.APARTMENT}>
                <SelectTrigger className='w-full'>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className='space-y-2'>
            ...
            <Input id='g-tags' defaultValue={item?.tags.join(', ')} placeholder={t('tagsPlaceholder')} />
          </div>
