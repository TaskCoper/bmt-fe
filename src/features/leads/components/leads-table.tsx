            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className='w-32'>{t('columns.needType')}</TableHead>
                  <TableHead>{t('columns.message')}</TableHead>
                  <TableHead className='w-28'>{t('columns.status')}</TableHead>
                  <TableHead className='w-32 text-right'>{t('columns.createdAt')}</TableHead>
              ...
              <TableBody>
                {data.items.map((lead) => (
                  <TableRow key={lead.id}>
                    ...
                    <TableCell>
                      <Badge variant='outline'>{t(`needType.${lead.needType}`)}</Badge>
                    </TableCell>
                    <TableCell className='text-muted-foreground max-w-xs truncate text-sm'>{lead.message}</TableCell>
                    <TableCell>
                      <Badge variant={STATUS_VARIANT[lead.status]}>{t(`status.${lead.status}`)}</Badge>
                    </TableCell>
